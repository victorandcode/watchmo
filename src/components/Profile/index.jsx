...
class Profile extends React.Component {
  ...
  getCommonContent() {
    return (
      <div>
        <img
          src={this.state.currentUser.iconUrl}
          alt="IconUrl"
        ...
        >
          {this.state.showingLinkContainer ? (
            <div className={styles.profileLinks}>
              <div
                className={[styles.linkGroup, styles.topBorderSeparator].join(
                  " "
                )}
              >
                <span className={styles.textLink} onClick={this.showAboutModal}>
                  About Watchmo
                </span>
              </div>
            </div>
        ...
        >
          ...
          >
            <div className={styles.modalContent}>
              "Discover <span className={styles.popular}>Popular</span> and{" "}
              <span className={styles.bizarre}>Bizzare</span> movies, take a
              look at their trailer, you like what you see?"
