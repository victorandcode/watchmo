...
import { clearSelectedMovie, triggerMovieAction } from "../../actions";
import { getMovieData } from "../../parsing";

const mapStateToProps = (state, ownProps) => {
  let movie =
    state.selectedMovie.movie !== undefined
      ? getMovieData(
          state.selectedMovie.movie,
          state.movieDetails[state.selectedMovie.movie.id]
        )
      : undefined;
  let isLoadingDetails =
    movie !== undefined && movie.detailsFetched === undefined;
  return {
    movie,
